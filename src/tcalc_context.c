...
tcalc_error_t tcalc_variable_def_alloc(char* name, double value, tcalc_vardef** out);
tcalc_error_t tcalc_binary_func_def_alloc(char* name, tcalc_binary_func function, tcalc_binary_funcdef** out);
tcalc_error_t tcalc_unary_func_def_alloc(char* name, tcalc_unary_func function, tcalc_unary_funcdef** out);
tcalc_error_t tcalc_binary_op_def_alloc(char* name, int precedence, tcalc_assoc associativity, tcalc_binary_func function, tcalc_binary_opdef** out);
tcalc_error_t tcalc_unary_op_def_alloc(char* name, int precedence, tcalc_assoc associativity, tcalc_unary_func function, tcalc_unary_opdef** out);

void tcalc_variable_def_free(tcalc_vardef* var_def);
void tcalc_binary_func_def_free(tcalc_binary_funcdef* binary_func_def);
void tcalc_unary_func_def_free(tcalc_unary_funcdef* unary_func_def);
void tcalc_binary_op_def_free(tcalc_binary_opdef* binary_op_def);
void tcalc_unary_op_def_free(tcalc_unary_opdef* unary_op_def);
...
tcalc_error_t tcalc_ctx_add_unary_func(tcalc_context* context, char* name, tcalc_unary_func function) {
  ...
  tcalc_unary_funcdef* unary_func;
...
tcalc_error_t tcalc_binary_func_def_alloc(char* name, tcalc_binary_func function, tcalc_binary_funcdef** out) {
  tcalc_binary_funcdef* binary_func = (tcalc_binary_funcdef*)malloc(sizeof(tcalc_binary_funcdef));
...
tcalc_error_t tcalc_unary_func_def_alloc(char* name, tcalc_unary_func function, tcalc_unary_funcdef** out) {
  tcalc_unary_funcdef* unary_func = (tcalc_unary_funcdef*)malloc(sizeof(tcalc_unary_funcdef));
...
tcalc_error_t tcalc_binary_op_def_alloc(char* name, int precedence, tcalc_assoc associativity, tcalc_binary_func function, tcalc_binary_opdef** out) {
  tcalc_binary_opdef* binary_op_def = (tcalc_binary_opdef*)malloc(sizeof(tcalc_binary_opdef));
...
tcalc_error_t tcalc_unary_op_def_alloc(char* name, int precedence, tcalc_assoc associativity, tcalc_unary_func function, tcalc_unary_opdef** out) {
  tcalc_unary_opdef* unary_op_def = (tcalc_unary_opdef*)malloc(sizeof(tcalc_unary_opdef));
...
void tcalc_binary_func_def_freev(void* binary_func_def) {
  tcalc_binary_func_def_free((tcalc_binary_funcdef*)binary_func_def);
}

void tcalc_unary_func_def_freev(void* unary_func_def) {
  tcalc_unary_func_def_free((tcalc_unary_funcdef*)unary_func_def);
}

void tcalc_binary_op_def_freev(void* binary_op_def) {
  tcalc_binary_op_def_free((tcalc_binary_opdef*)binary_op_def);
}

void tcalc_unary_op_def_freev(void* unary_op_def) {
  tcalc_unary_op_def_free((tcalc_unary_opdef*)unary_op_def);
}
